...
const functions = computed(() => [
  { id: 1, name: t('homeFeatures.loveAssistant'), description: currentLocale.value === 'zh' ? '帮你回消息、哄人、推进关系' : 'Help reply messages, comfort, advance relationships', icon: 'icon_aiqing', bgColor: '#FFEEF2', path: '/love-assistant' },
  { id: 2, name: t('homeFeatures.emotionCompanion'), description: currentLocale.value === 'zh' ? '当你孤单、想念时给你安慰' : 'Comfort when you are lonely or missing someone', icon: 'icon_peiban', bgColor: '#E8F4F8', path: '/emotion-companion' },
  { id: 3, name: t('homeFeatures.emotionTreeHole'), description: t('homeFeatures.keepSecret'), icon: 'icon_tree', bgColor: '#FAF5E6', path: '/tree-hole' },
  { id: 4, name: t('homeFeatures.tarotWorld'), description: currentLocale.value === 'zh' ? '带你感受一下玄学世界' : 'Experience the mystical world', icon: 'icon_tarot', bgColor: '#F3E8FF', path: '/tarot' }
])
